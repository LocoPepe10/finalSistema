...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('img/icon1.png')); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('img/icon2.ico')); ?>">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-tabs flex-column mr-auto">
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('ventas/venta')); ?>"><i class="fas fa-cash-register"></i> Ventas </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('almacen/categoria')); ?>"><i class="fas fa-dolly fa-lg"></i> Categoria </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('compras/ingreso')); ?>"><i class="far fa-clipboard fa-lg"></i> Ingresos </a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="sesionMenu">
                  <a  href="<?php echo e(url('/')); ?>" class="dropdown-item"> Inicio de Sesión </a>
