...
<?php echo Form::model($persona,['method'=>'PATCH','route'=>['compras.proveedor.update',$persona->idpersona]]); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="direccion" required value="<?php echo e($persona->direccion); ?>" class="form-control" placeholder="Dirección..."/>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="num_documento" required value="<?php echo e($persona->num_documento); ?>" class="form-control" placeholder="num_documento..."/>                
            </div>                
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
